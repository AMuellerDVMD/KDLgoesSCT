...
* ^url = "http://www.dvmd.de/kdl/CodeSystem/KDL"
* ^version = "2025"
* ^valueSet =  "http://www.dvmd.de/kdl/ValueSet/KDL"
* ^caseSensitive = false
* ^versionNeeded = false
* ^content = #complete
...
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#sector"
...
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#component"
* ^property[=].description = "welche Komponenten enthält diese Dokumentenklasse"
* ^property[=].type = #code

* ^property[+].code = #kbv-relevant
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#kbv-relevant"
* ^property[=].description = "ist diese Dokumentenklasse für die KBV relevant"
* ^property[=].type = #boolean

* ^property[+].code = #bg
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#bg"
* ^property[=].description = "BG"
* ^property[=].type = #boolean

* ^property[+].code = #art
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#art"
* ^property[=].description = "Art des Dokuments"
* ^property[=].type = #string

* ^property[+].code = #typeCode
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#typeCode"
* ^property[=].description = "IHE XDS typeCode"
* ^property[=].type = #code

* ^property[+].code = #classCode
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#classCode"
* ^property[=].description = "IHE XDS classCode"
* ^property[=].type = #code

* ^property[+].code = #anwender
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#anwender"
* ^property[=].description = "wer ist der Anwender?"
* ^property[=].type = #string

* ^property[+].code = #ablageort
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#ablageort"
* ^property[=].description = "Ablageort"
* ^property[=].type = #string

* ^property[+].code = #dokzeit
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#dokzeit"
* ^property[=].description = "Zeitpunkt der Dokumententation"
* ^property[=].type = #string

* ^property[+].code = #dokart
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#dokart"
* ^property[=].description = "Art der Dokumentation"
* ^property[=].type = #string

* ^property[+].code = #inhalt
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#inhalt"
* ^property[=].description = "Inhalte"
* ^property[=].type = #code

* ^property[+].code = #practiceSetting
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#practiceSetting"
* ^property[=].description = "IHE XDS practiceSetting"
* ^property[=].type = #code

* ^property[+].code = #snomed
* ^property[=].uri = "http://www.dvmd.de/kdl/CodeSystem/Property#snomed"
* ^property[=].description = "Snomed CT"
* ^property[=].type = #code
...
* ^url = "http://www.dvmd.de/kdl/ValueSet/KDL"
* ^version = "2025"
* ^status = #draft
* ^experimental = false
